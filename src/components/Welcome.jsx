...
const Welcome = () => {
  return (
    <div className='flex flex-col lg:flex-row w-11/12 lg:w-full h-[80vh] justify-between items-center pl-4 lg:px-28 z-10'>
        {/* Text */}
        <div className='flex-1 h-full flex flex-col justify-center'>
            <div className='flex flex-col gap-y-8 '>
                <div>
                    <h5 className='uppercase text-xl text-black font-normal'>
                        Welcome to the Digi School 
                    </h5>
                    <h1 className='uppercase text-5xl text-black font-bold'>UK IT Courses in Nepal</h1>
                </div>
