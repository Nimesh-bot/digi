...
const Welcome = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row w-full h-[80vh] justify-between lg:items-center overflow-hidden px-4 md:px-8 lg:px-20 py-8 lg:py-0' ref={HomeSection}>
        {/* Text */}
