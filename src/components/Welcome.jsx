...
const Welcome = () => {
  return (
    <div className='flex flex-col lg:flex-row w-full h-[80vh] justify-between lg:items-center overflow-hidden px-4 md:px-8 lg:px-20 py-8 lg:py-0' id="home">
        {/* Text */}
        <div className='flex-1 h-full flex flex-col justify-center'>
            <div className='flex flex-col gap-y-8 '>
                ...
                <div className='w-11/12 md:w-auto flex flex-col md:flex-row gap-y-4 gap-x-4 lg:items-center'>
                    <Link to="integrate" smooth={true}><button className='bg-blue text-white rounded px-4 py-2 hover:bg-blue_dark'>INTEGRATE NOW</button></Link>
